...
const SimpleArc = props =>{
    return(
        <h1>
            ...
            <span className="char5">M</span>
            <span className="char6">a</span>
            <span className="char7">r</span>
            <span className="char8">k</span>
            ...
            <span className="char18">n</span>
            <span className="char19">m</span>
            <span className="char20">e</span>
            <span className="char21">n</span>
            <span className="char22">t</span>

            <span className="char23">T</span>
            <span className="char24">e</span>
            <span className="char25">c</span>
            <span className="char26">h</span>
            <span className="char27">n</span>
            <span className="char28">o</span>
            <span className="char29">l</span>
            <span className="char30">o</span>
            <span className="char31">g</span>
            <span className="char32">y</span>
        </h1>
    );
}
